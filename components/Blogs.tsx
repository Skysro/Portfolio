  ...
  return (
    <section className="w-full py-20" id="blogs">
      <h1 className="heading">
        My Latest <span className="text-purple">Blogs</span>
      </h1>
      {/* remove bg-white dark:bg-black */}
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <a href="https://medium.com/@pritamleicapanda/the-evolution-of-web-development-in-india-a-contemporary-perspective-5fb861a3bd33">
          {/* add des prop */}
          <Card
            title="The Evolution of Web Development in India: A Contemporary Perspective"
            icon={<AceternityIcon order="Blog 1" />}
            href=""
